         ...
         if(flag === "none"){
          ...
          $('.winner-click .winners-info-hide').not(info).hide().parent().css({"background-color":"#001132","border":"3px solid #FFFFFF"});
         ...
         if(flag === "none"){
           ...
           $(this).find('.more-info').hide();
           $(this).css({"border":"2px solid #E6AE5C","background-image":"url(images/arrow-hide-up.png)"});
           // $('.winners-info-hide').not(eto).hide();
           // console.log(this)
           }
           else{
          ...
          $('.arow-mob').not(info).hide().parent().css({"border":"2px solid #FFFFFF","background-image":"url(images/arrow-hide.png)"});
          $('.more-info').not(arrow).show(".more-info")
         })
         ...
         $(".question").on('click',function(){
         	$(this).parent().find('.question').css({"color":"#FAFAFF"});
         	$(this).css({"color":"#E6AE5C"});
         })
